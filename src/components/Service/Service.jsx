    ...
    <div className="mt-[30px]">
      <div className="flex">
        <div className="w-[50%] flex justify-end pr-[60px]">
          <div className="w-[509px] pt-[106px]">
            <h3 className="font-poppins font-bold text-[64px] text-primary">
              Our Services
            </h3>
            <p className="w-[405px] font-poppins font-medium text-[16px] text-secondary">
        ...
        <div className="w-[50%]">
          <div className="relative bg-[url(./assets/serviceOne.png)] bg-cover bg-no-repeat bg-center after:absolute after:content-[''] after:top-0 after:left-0 after:w-full after:h-full after:bg-black/60 z-[-1]">
            <div className="relative z-[1] pt-[147px] pl-[115px] pb-[140px]">
